...
{
 struct node *ptr1,*ptr2,*start5,*start6;
 start6=NULL;
 ptr1=start1;
...
while(ptr1!=NULL)
 {
   ...
   ptr2=start2;
     ...
     while(ptr2!=NULL)
     {
       start5=add_node(start5,ptr1->coeff*ptr2->coeff,ptr1->power+ptr2->power);
        ptr2=ptr2->next;
     }
 start6=add_poly(start6,start5,start7);
 ptr1=ptr1->next;
}
return start6;
}
...
int main()
{
    ...
    start3 = mul_poly(start1, start2, start3);
    printf("\n Display the product: ");
