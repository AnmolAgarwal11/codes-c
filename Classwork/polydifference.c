...
struct node *substract_poly(struct node *start1,struct node *start2,struct node *start3)
{
...
int main()
{
 ...
 printf("\n Substract the two polynomials");
 start3=substract_poly(start1,start2,start3);
